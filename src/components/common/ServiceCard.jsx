  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Image / Icon — top 65% with soft accent tint bg */}
        <div
        ...
        {/* Title + Get quote — bottom section (35% height) */}
        <div className="flex flex-col items-center justify-center flex-shrink-0 py-3 px-3" style={{ height: '35%' }}>
          <h3
            className="font-display font-semibold leading-tight transition-colors duration-300 text-center"
